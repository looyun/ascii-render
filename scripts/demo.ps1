...
$binaryUrl = "https://github.com/anomalyco/ascii_render/releases/download/$Version/$binary"
$gifUrl = "https://github.com/anomalyco/ascii_render/releases/download/$Version/example.gif"
